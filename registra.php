...
<body>
          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item me-3"><a class="nav-link active" href="registra.php">Registra</a></li>
              </ul>
            </div>
          </div>
        </nav>
    ...
    <div class="container mt-4">
        ...
        <form action="link/registrazione.php" method="POST" class="mb-4">
            ...
            <button type="submit" class="btn btn-primary">Registra</button><br><br>
            <a href="accedi.php">Hai già l'account? Accedi</a>
        </form>
    </div>
